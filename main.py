...
parser.add_argument('--tau', type=int, default=100, help='tao for softmax')
...
def main():
    ...
    model = trans_to_cuda(CARES(opt, n_node,n_cate))
    ...
    for epoch in range(opt.epochs):
        ...
        print('Best Result:')
        print('\tP@20:\t%.4f\tMRR@20:\t%.4f\tEpoch:\t%d,\t%d'% (best_result[0], best_result[1], best_epoch[0], best_epoch[1]))
        bad_counter += 1 - flag
